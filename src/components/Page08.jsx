...
const Page08 = (props) => {
    ...
    return (
        <div>
            ...
            <div className='w-100'><h2 className='text-center mb-3'>Какой способ оплаты удобнее?</h2></div>
            <div className="w-100 text-center">
                <div className="inputTextContainer ">
                    ...
                    <InputRadioText changeInput={props.setPaymentMethod}
                                    text="Рассрочка без банка на 6 месяцев" name="paymentMethod3"
                                    value="paymentMethod3" id="Рассрочка без банка на 6 месяцев"
                                    checked={props.paymentMethod}/>
                    <InputRadioText changeInput={props.setPaymentMethod} text="Кредит"
                                    name="paymentMethod5" value="paymentMethod5" id="Кредит"
                                    checked={props.paymentMethod}/>
                </div>
            </div>
